...
function Home() {
  ...
  const numberlist = [
    ...
    {
      id: 3,
      num: stats.participations,
      description: "Participations confirmées",
      suffix: "+",
    },
    {
      id: 4,
      num: stats.satisfaction,
  ...
  const introliste = [
    {
      ...
      description:
        "Des milliers d'événements adaptés à vos goûts et localisation.",
      icon: (
        <svg
          width="32"
          height="32"
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          strokeLinejoin="round"
        >
          <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-2.312-3.406-3-5-3 5.4-1 6.5-1 10.5h0z"></path>
          <path d="M12 2v2"></path>
          <path d="M15.5 14.5A2.5 2.5 0 0 0 18 12c0-1.38-.5-2-1-3-1.072-2.143-2.312-3.406-3-5-3 5.4-1 6.5-1 10.5h0z"></path>
        </svg>
      ),
    },
  ];
        ...
        <div className="hero-section">
          ...
          >
            ...
            <p className="hero-subtitle">
              La plateforme ultime pour créer, découvrir et partager des
              événements exceptionnels. Rejoignez une communauté passionnée dès
              aujourd'hui.
            </p>
